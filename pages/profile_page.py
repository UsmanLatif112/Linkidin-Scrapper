                ...
                try:
                    ...
                    for container in education_containers:
                        ...
                        with contextlib.suppress(Exception):
                            ...
                            print(degree, "_______________________________________93")
                        with contextlib.suppress(Exception):
                            institude = self.find_from_element(container, ProfileResources.institude).text
                            print(institude, "_______________________________________96")
                        with contextlib.suppress(Exception):
                            date = self.find_from_element(container, ProfileResources.date).text.split(' · ')[0]
                            from_date = date.split(' - ')[0]
                            print(from_date, "_______________________________________100")
                            with contextlib.suppress(Exception):
                                to_date = date.split(' - ')[1]
                                print(to_date, "_______________________________________103")
